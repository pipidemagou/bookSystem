...
import domain.User;
import service.BussinessServiceDao;
import utils.PrivilegeException;
import utils.ServiceDaoFactory;
...
public class CategoryServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        BussinessServiceDao service = ServiceDaoFactory.getInstance().createDao("service.impl.BussinessServiceImpl", BussinessServiceDao.class, (User) request.getSession().getAttribute("user"));
